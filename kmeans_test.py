...
# TODO: Try an alternate implementation using slicing or indexing
# of numpy array instead of taking crops out of the image.
def image_kmeans_tile():
    ...
    for rect in image_rect_range(image.size, step_size):
        ...
        # print(f"First array shape {img_arr.shape}")

        flattened_arr = img_arr.reshape(-1, 3)
        # print(f"Reshaped array {flattened_arr.shape}")
